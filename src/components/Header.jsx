export default function Header() {
  return (
    <header className="relative overflow-hidden rounded-3xl border border-primary-200 bg-white p-8 mb-8">
      <div className="relative z-10 flex flex-col gap-3 text-center sm:text-left">
        <span className="text-sm uppercase tracking-[0.4em] text-primary-600">
